...
namespace eval usr_access_master {
  ...
  proc get_design_files {QSYS_SIMDIR} {
    ...
    lappend design_files "-makelib altera_avalon_mm_bridge_2010 \"[normalize_path "$QSYS_SIMDIR/../altera_avalon_mm_bridge_2010/sim/usr_access_master_altera_avalon_mm_bridge_2010_xnk2xbi.v"]\"   -end"
