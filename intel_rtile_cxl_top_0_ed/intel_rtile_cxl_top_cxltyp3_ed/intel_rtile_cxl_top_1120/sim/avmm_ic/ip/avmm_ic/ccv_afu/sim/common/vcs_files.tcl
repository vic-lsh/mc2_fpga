...
namespace eval ccv_afu {
  ...
  proc get_design_files {QSYS_SIMDIR} {
    set design_files [dict create]
    dict set design_files "ccv_afu_altera_avalon_mm_bridge_2010_xnk2xbi.v" "$QSYS_SIMDIR/../altera_avalon_mm_bridge_2010/sim/ccv_afu_altera_avalon_mm_bridge_2010_xnk2xbi.v"
