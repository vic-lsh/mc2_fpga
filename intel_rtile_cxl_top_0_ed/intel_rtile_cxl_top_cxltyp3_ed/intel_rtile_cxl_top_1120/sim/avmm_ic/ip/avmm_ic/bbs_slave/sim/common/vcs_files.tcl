...
namespace eval bbs_slave {
  ...
  proc get_design_files {QSYS_SIMDIR} {
    set design_files [dict create]
    dict set design_files "bbs_slave_altera_avalon_mm_bridge_2010_xnk2xbi.v" "$QSYS_SIMDIR/../altera_avalon_mm_bridge_2010/sim/bbs_slave_altera_avalon_mm_bridge_2010_xnk2xbi.v"
