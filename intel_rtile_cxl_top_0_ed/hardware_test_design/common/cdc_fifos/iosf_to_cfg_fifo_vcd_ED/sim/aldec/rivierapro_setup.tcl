...
# ACDS 24.1 115 linux 2025.03.13.23:18:35
# ----------------------------------------
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [iosf_to_cfg_fifo_vcd_ED::get_memory_files "$QSYS_SIMDIR"]]
...
alias com {
  ...
  set design_files [concat $design_files [iosf_to_cfg_fifo_vcd_ED::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
