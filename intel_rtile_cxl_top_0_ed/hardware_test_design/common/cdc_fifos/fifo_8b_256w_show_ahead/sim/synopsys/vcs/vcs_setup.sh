...
TOP_LEVEL_NAME="fifo_8b_256w_show_ahead"
QSYS_SIMDIR="./../../"
...
source $QSYS_SIMDIR/common/vcs_files.tcl
set files [dict merge $files [fifo_8b_256w_show_ahead::get_common_design_files "$QSYS_SIMDIR"]]
...
set QSYS_SIMDIR [lindex $argv 1]
source $QSYS_SIMDIR/common/vcs_files.tcl
if {[catch {fifo_8b_256w_show_ahead::get_design_files "$QSYS_SIMDIR"} errorMsg]} {
 puts "Catch error: $errorMsg"
 exit 1 
}
set files [dict create]
set files [dict merge $files [fifo_8b_256w_show_ahead::get_design_files "$QSYS_SIMDIR"]]
