...
# ACDS 24.1 115 linux 2025.03.13.23:18:17
# ----------------------------------------
# Auto-generated simulation script rivierapro_setup.tcl
# ----------------------------------------
# This script provides commands to simulate the following IP detected in
# your Quartus project:
#     fifo_8b_256w_show_ahead
# 
...
# ----------------------------------------
# If fifo_8b_256w_show_ahead is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "fifo_8b_256w_show_ahead.fifo_8b_256w_show_ahead"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [fifo_8b_256w_show_ahead::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [fifo_8b_256w_show_ahead::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [fifo_8b_256w_show_ahead::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [fifo_8b_256w_show_ahead::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [fifo_8b_256w_show_ahead::normalize_path "$file"]
  set normalized_dest [fifo_8b_256w_show_ahead::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [fifo_8b_256w_show_ahead::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [fifo_8b_256w_show_ahead::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [fifo_8b_256w_show_ahead::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [fifo_8b_256w_show_ahead::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
